...
library(lattice)
library(readxl)
Table_2_3_Birthweight_and_gestational_age <- read_excel("Table_2_3_Birthweight_and_gestational_age.xls")
```
...
###Question 2
```{r Question 2}
tails.distr.df <- data.frame(value = c(0,1,2,3,4), prob= c(.0625, .25, .375, .25, .0625))
tails.distr.df
```
...
```
Q7. The weight seems highly dependent on age and not sex. 
